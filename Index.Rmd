...
```{r fig.cap = "This is an animation that changes from a choropleth map to a hexagon tile map of Australian Statistical Areas at Level 2 using Standardised Incidence Ratios taken from the Australian Cancer Atlas website."}
