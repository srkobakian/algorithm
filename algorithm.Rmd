---
title: A Hexagon Tile Map Algorithm For Spatial Mapping To Create Alternative Australian Maps
author:
...
\begin{figure}[h]
\centering
\includegraphics[width=14cm]{figures/qld_grid.pdf}
...
\begin{figure}[h]
\centering
\includegraphics[width=14cm]{figures/aus_gghexmap.pdf}
...
<!-- knitr::include_graphics(path = "figures/2grid.pdf") -->
<!-- ``` -->
...
<!-- knitr::include_graphics(path = "figures/3grid.pdf", dpi = 300) -->
<!-- ``` -->
...
<!-- knitr::include_graphics(path = "figures/4grid.pdf") -->
<!-- ``` -->
