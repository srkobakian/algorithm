...
```{r filterprocess, fig.cap = "Filter for grid points within a square, then circular, distance for those closest to the centroid.", echo = FALSE, height = 8}
...
f2 <- ggplot() + 
  ...
  geom_point(aes(x = hex_long, y = hex_lat), colour = "#09661f", fill = "white", data = hex, size = 1.5, shape = 21) + ggtitle("d")
