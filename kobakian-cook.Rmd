...
```{r tas_displays, width = 10, height = 3, fig.cap = "The three displays show alternative maps of the Australian state of Tasmania. These alternatives show the (a) contiguous cartogram, (b) non-contiguous cartogram and (c) Dorling cartogram of Tasmania."}
library(gridExtra)
