...
This paper contains a discussion of Existing Mapping Practices. This is followed by details of the Algorithm. The implementation section discusses the algorithm in the \CRANpkg{sugarbag} package. Finally, the use and benefits of animation are presented.
