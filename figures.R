...
act_map <- absmapsdata::state2011 %>% 
  filter(state_name_2011 == "Australian Capital Territory") %>% st_transform(., 3112) %>% 
  ggplot() + 
  theme_void() +
  geom_sf(fill = "white") + 
...
fort_sa2 <- qld_sa2 %>% fortify_sfc()

hex_size <- .25
buffer_dist <- 2

centroids <- sugarbag::create_centroids(shp_sf = qld_sa2, sf_id = sf_id)
...
ggsave(filename = "figures/qld_centroids.png", plot = t0,
  device = "png", bg = "transparent", dpi = 300,  width = 10, height = 10)
...
ggsave(filename = "figures/qld_1grid.png", plot = t1,
  device = "png", bg = "transparent", dpi = 300,  width = 10, height = 10)
...
ggsave(filename = "figures/qld_2hexgrid.png", plot = t2,
  device = "png", bg = "transparent", dpi = 300,  width = 10, height = 10)
...
ggsave(filename = "figures/qld_3buffer.png", plot = t3,
  device = "png", bg = "transparent", dpi = 300,  width = 10, height = 10)
...
ggsave(filename = "figures/qld_4centroid1.png", plot = t4,
  device = "png", bg = "transparent", dpi = 300,  width = 10, height = 10)
...
ggsave(filename = "figures/qld_5centroid1.png", plot = t5,
  device = "png", bg = "transparent", dpi = 300,  width = 10, height = 10)
...
ggsave(filename = "figures/qld_6centroid1.png", plot = t6,
  device = "png", bg = "transparent", dpi = 300,  width = 10, height = 10)
...
ggsave(filename = "figures/qld_7centroid1.png", plot = t7,
  device = "png", bg = "transparent", dpi = 300,  width = 10, height = 10)
## ------------------------------------------------------------------------
...
ggsave(filename = "figures/qld_8centroid1.png", plot = t8,
  device = "png", bg = "transparent", dpi = 300,  width = 10, height = 10)
...
all_areas <- rbind(fort_hex, qld_sa2)


library(gganimate)
ggplot(all_areas) +  
  geom_sf(aes(group= sa2_name_2011), fill = "#d69d6f", colour = "black", size = 0.01) +
