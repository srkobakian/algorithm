...
\Plainauthor{Stephanie Kobakian, Dianne Cook}
...
points can be found within the \code{hex_filter} distance. The
...
\begin{CodeInput}
R> knitr::include_graphics("figures/aus_liver_m.png")
\end{CodeInput}


\begin{center}\includegraphics[width=41.67in]{figures/aus_liver_m} \end{center}
...
\begin{CodeInput}
R> knitr::include_graphics("figures/aus_liver_m_hex.png")
\end{CodeInput}


\begin{center}\includegraphics[width=41.67in]{figures/aus_liver_m_hex} \end{center}
...
the \citet{sugarbag} package written for \citet{R}. The \pkg{sugarbag}
...
The code for sugarbag \citep{sugarbag} can be found on
