...
title: 
  formatted: "An Algorithm For Spatial Mapping Using a Hexagon Tile Map, \n With Application to Australian Maps"
  plain: "An Algorithm For Spatial Mapping Using a Hexagon Tile Map, With Application to Australian Maps"
  short: "An Algorithm For Spatial Mapping Using a Hexagon Tile Map"  
abstract: >
...
Australian population is the statistic of interest, the result is a population cartogram. They fail to preserve a recognisable display due to the difference in size of metropolitan and rural areas \citep{ACTUC}, \citep{GOINO}.
