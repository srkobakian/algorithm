...
XXX Show whole Australia male liver cancer with choropleth and hexagon tile map, and discuss the pros/cons of the result, for understanding the incidence.
...
XXX Move this image (ref: sir) to the end of the algorithm section to illustrate the final result for Tassie
...
The code for sugarbag can be found at XXX, along with details on installation and usage. 
