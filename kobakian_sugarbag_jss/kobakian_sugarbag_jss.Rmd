...
The concept of tile mapping with both hexagons and squares is not unfamiliar in practice. In fact there are many prominent news sites that utilise these techniques, these include [@NPR], [@FiveThirtyEight], [@WSJ], [@WP]. 
A common applicate of the hexagon tile map is election mapping for United States of America. 
...
The code for sugarbag [@sugarbag] can be found on [CRAN](https://cran.r-project.org/web/packages/sugarbag/index.html), along with vignettes on installation and usage. 
