...
cents <- ggplot() + 
  geom_polygon(aes(x = long, y = lat, group = interaction(sa2_name_2011, polygon)), data = fort_sa2, fill = "grey", size = 0.2, colour = "lightgrey") + 
  geom_point(aes(x=longitude, y = latitude), shape=21, fill = "#b2df8a", data = centroids) + 
  theme_void() + coord_equal()

ggsave(file = "1centroids.png", cents, width = 10, height = 5, units = "in", dpi = 300)
...
grid1 <- ggplot() + geom_polygon(aes(x = long, y = lat, group = interaction(sa2_name_2011, polygon)), data = fort_sa2, fill = "grey", size = 0.2, colour = "lightgrey") +
...
grid2 <- ggplot() + 
  geom_polygon(aes(x = long, y = lat, group = interaction(sa2_name_2011, polygon)), data = fort_sa2, fill = "grey", size = 0.2, colour = "lightgrey") + 
     geom_point(aes(x=longitude, y = latitude), shape=21, fill = "#b2df8a", colour = "black", data = centroids) + theme_void() + coord_equal() +
  geom_point(aes(x = hex_long, y = hex_lat), colour = "#1f78b4", data = grid, size = 0.75) 
...
g3 <- ggplot() + geom_polygon(aes(x = long, y = lat, group = interaction(sa2_name_2011, polygon)), data = fort_sa2, fill = "grey", size = 0.2, colour = "lightgrey")  +
  geom_polygon(aes(x = long, y = lat, group = id), data = fort_grid, fill = NA, colour = "#a6cee3") +
  geom_point(aes(x=longitude, y = latitude), data = centroids, shape = 21, colour = "black", fill = "#b2df8a") + theme_void() + coord_equal() +
  geom_point(aes(x = hex_long, y = hex_lat), colour = "#1f78b4", data = grid, size = 0.75)
...
buff1 <- ggplot() +
  geom_polygon(aes(x = long, y = lat, group = interaction(sa2_name_2011, polygon)), data = fort_sa2, fill = "grey", size = 0.2, colour = "lightgrey") + 
  geom_point(aes(x=longitude, y = latitude), data = centroids, shape = 21, colour = "black", fill = "#b2df8a")  + 
...
buff3 <- ggplot() + geom_polygon(aes(x = long, y = lat, group = interaction(sa2_name_2011, polygon)), data = fort_sa2, fill = "grey", size = 0.2, colour = "lightgrey") +  
  geom_polygon(aes(x = long, y = lat, group = interaction(sa2_name_2011, polygon)), data = fort_sa2, fill = "grey", size = 0.2, colour = "lightgrey") + 
  geom_point(aes(x=longitude, y = latitude), data = centroids, shape = 21, colour = "black", fill = "#b2df8a")  + 
...
buff4 <- ggplot() + geom_polygon(aes(x = long, y = lat, group = interaction(sa2_name_2011, polygon)), data = fort_sa2, fill = "grey", size = 0.2, colour = "lightgrey") +  
  geom_point(aes(x=longitude, y = latitude), data = centroids, shape = 21, colour = "black", fill = "#b2df8a")  + 
  geom_point(aes(x=focal_longitude, y = focal_latitude), data = centroid1, colour = "red") +
  geom_point(aes(x=longitude, y = latitude), data = centroid1, colour = "orange") +
  geom_polygon(aes(x = long, y = lat, group = id), data = fort_grid, fill = NA, colour = "#a6cee3") + 
...
g5 <- arrangeGrob(buff3, buff4, nrow = 1)
ggsave(file = "5allocate.png", g5, width = 10, height = 5, units="in", dpi = 300)
...
p1 <- fortify_sfc(sa2)
end_hex <- ggplot() +
  geom_polygon(data = p1, aes(x=long, lat, group = interaction(sa2_name_2011, polygon)), fill = "grey", size = 0.2, colour = "lightgrey") +
  geom_polygon(aes(x=long, y = lat, group = sa2_name_2011), data = h1, colour = "black", fill = "#b2df8a") + theme_void() + coord_equal()
...
sf_SIR <- ggplot() + 
  geom_polygon(aes(x = long, y = lat, 
    group = interaction(sa2_name_2011, polygon), fill = SIR), data = sa2_SIR, size = 0.2, colour = "lightgrey") + 
  theme_void() + coord_equal() +
  scale_fill_identity()
sf_SIR
