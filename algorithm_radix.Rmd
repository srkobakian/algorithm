...
```{r fullhexmap}
lga_map <- create_hexmap(shp = tas_sa2, sf_id = "SA2_5DIG16", buffer_dist = NULL, filter_dist = 10, export_shp = FALSE, focal_points = sugaRbag::capital_cities, projstring = projstring, verbose = TRUE)
