...
discusses the algorithm in the \pkg{sugarbag} package. Finally, the use
...
collective landmass. The \pkg{gganimate} \citep{gganimate} package can
be used to make an animation. It connects the polygons for each area in
the two displays using the \code{sf\_id} variable, the names of the
