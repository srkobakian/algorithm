...
There are several key steps needed to create the hexagon tile map as
...
the buffer distance, for each row and column of the grid. Figure 5b
displays remaining hexagon grid points after applying the buffer step.
The sparsely populated South-West region of National Park has very few
points available compared to the South-East region near the city of
Hobart.
...
centroid and it's closest focal point. For this example, this distance
is only calculated for the capital city of Hobart.
