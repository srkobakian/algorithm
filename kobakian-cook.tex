...
\CRANpkg{cartogram}, allow increased understanding of the spatial
...
\CRANpkg{tilemaps}, all use one simple shape to represent each
...
There are many possible extensions to the algorithm that might be
